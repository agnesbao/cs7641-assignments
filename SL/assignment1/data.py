...
class data:
    ...
    def load_data(self):
        if self.data_name == "credit":
            ...
            dat = pd.read_csv("dataset_31_credit-g.csv")
        elif self.data_name == "wine":
            # http://archive.ics.uci.edu/ml/datasets/Wine+Quality
            dat = pd.read_csv("winequality-white.csv", sep = ";")
        self.X = dat.iloc[:, :-1]
        self.y = dat.iloc[:, -1]
    ...
    def plot_X(self):
        self.X.plot.box(logy=True, rot=90, figsize=(7,7), title="Distribution of features")
